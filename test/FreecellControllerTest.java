...
/**
 * A test class for the Freecell Controller. Tests ensure that a freecell controller works
 * correctly.
 */
public class FreecellControllerTest {

  FreecellOperations m = new FreecellModel();
  ...
  public void testMoveToOpen() {
    ...
    c.playGame(m.getDeck(), m, 5, 4, false);
    assertEquals("F1:\n"
        + "F2:\n"
        + "F3:\n"
        + "F4:\n"
  ...
  public void testInvalidSourcePileNumForMove() {
    ...
    assertEquals(""
        ...
        + "C7: 7♣, Q♦, 4♦, 9♥, A♥, 6♠\n"
        + "C8: 6♣, J♦, 3♦, 8♥, K♠, 5♠\n"
        + "Invalid move. Try again. Pile number is greater than number of piles.\n"
        + "Game quit prematurely.", gameLog.toString());
  }
  ...
  public void testNullModel() {
    FreecellController c = new FreecellController(new StringReader("C1 7 O1 q"), gameLog);
    c.playGame(m.getDeck(), null, 8, 5, false);
  }
  ...
  public void testNullReadable() {
    ...
    c.playGame(m.getDeck(), m, 8, 5, false);
  }
  ...
  public void testInvalidNumCascadesPlayGame() {
    FreecellController c = new FreecellController(new StringReader("C1 7 O1 q"), gameLog);
    c.playGame(m.getDeck(), m, 0, 5, false);
  ...
  public void testInvalidNumOpenPlayGame() {
    FreecellController c = new FreecellController(new StringReader("C1 7 O1 q"), gameLog);
    c.playGame(m.getDeck(), m, 8, 0, false);
